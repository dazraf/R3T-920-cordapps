...
@InitiatingFlow
@StartableByRPC
class TransferNote(private val noteStateRefString: String, private val newOwner: Party) : FlowLogic<String>() {
  companion object {
  ...
  override fun call(): String {
    ...
    val txBuilder = TransactionBuilder(notary)
      .addInputState(sar)
      .addOutputState(outputState.ownableState)
    ...
    val ft = subFlow(FinalityFlow(fullySignedTx, setOf(otherPartySession)))
    return StateRef(ft.id, 0).toString()
  }
